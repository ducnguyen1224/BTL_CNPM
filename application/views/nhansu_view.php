                ...
                <div class="wrapper">
                  ...
                  <div class="info-wrapper">
                    <div class="contents">
                      ...
                      <p class="socials">
                        <a href="<?= base_url() ?>nhansu/sua_nhansu/<?=$value['id']?>" class="social"><i class="fa-sharp fa-solid fa-user-pen" style="margin-right:15%;font-size: 150%;"></i></a>
                        <a href="<?= base_url() ?>nhansu/xoa_nhansu/<?=$value['id']?>" class="social"><i class="fa-sharp fa-solid fa-trash" style="margin-left:15%;font-size:150%;"></i></a>
                      </p>
                    </div>
...
<button class="btn"  onclick="scrollToTop()" id="scrollToTopBtn" title="Go to top">
