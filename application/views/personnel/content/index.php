...
<form method="post" enctype="multipart/form-data" action="<?= site_url('nhansu/nhansu_add') ?>">
...
<div class="container">
	<nav class="navbar navbar-light bg-light">
		<form class="form-inline" method="get" action="<?= site_url('nhansu/tim_kiem') ?>">
			<input class="form-control mr-sm-2" type="search" name="search_name" placeholder="Enter the full name"
				   aria-label="Search">
								...
								<div class="wrapper">
									...
									<div class="info-wrapper">
										<div class="contents">
											...
											<div class="socials">
												<a href="<?= $value['linkpin'] ?>" class="social"><i
														class="fa-brands fa-pinterest" style="font-size: 150%;"></i></a>
												<a href="<?= $value['linkfb'] ?>" class="social"><i
														class="fa-brands fa-facebook-f"
														style="font-size: 150%;"></i></a>
												<a href="<?= $value['linkgit'] ?>" class="social"><i
														class="fa-brands fa-github" style="font-size: 150%;"></i></a>
											</div>
											<div class="card-block">
												<div class="card-text-age-phone" style="margin-bottom: 7%;">
													<b>Age</b> : <?= $value['age'] ?>
													<i class="fa-solid fa-phone" style="margin-left:5%"></i>
													: <?= $value['phone'] ?>
												</div>
												<p class="card-text positon"><b>Position</b> : <?= $value['position'] ?>
												</p>
												<p class="card-text department"><b>Department</b>
													: <?= $value['department'] ?></p>
...
<script src="<?= base_url() ?>/1.js"></script>
